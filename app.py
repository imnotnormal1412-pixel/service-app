...
if 'services' not in st.session_state:
    st.session_state.services = {
        ...
        "Знижка постійному клієнту": {"category": "Знижки", "price": 10%},
        "Акція вихідного дня": {"category": "Знижки", "price": 15%}
        "Знижка пенсіонер": {"category": "Знижки", "price": 15%}
        "Знижка військовий": {"category": "Знижки", "price": 20%}
        "Знижка ВПО": {"category": "Знижки", "price": 20%}
    }
